...
echo"</body>";
$query=pg_query(" Select fname,mname,lname,gender,city,address,phone,mhist from user1")or die("Cannot Select");
if(pg_num_rows($query)>0)
{
         echo"<html><body><center><h2>User Details<br><br>";
echo"<table border=1><tr><th>fname</th><th>mname</th><th>lname</th><th>gender</th><th>City</th><th>Address</th><th>phone</th><th>mhist</th></tr>";
...
echo"</table></center></h2></body></html>";
 echo"<center><a href='doctor_page.html'>Finish</a></center>";
pg_close($db);
?>
