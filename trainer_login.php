...
$query="select * from trainer where tname='$username' and email='$email'";
$res=pg_query($db,$query);
$count=pg_num_rows($res);
if($count>0)
{
  $query1="select tid from trainer where tname='$username' and email='$email'";
...
else
{
  ...
  echo "<div class='message'><a href='trainer_login.html'>Go back</a></div>";
}
